...
<div class="container">
  <picker @change="bindPickerChange" :value="index" :range="array">
    <div class="picker">
      <div class="fb-type">
        <div class="type-label">{{array[index]}}</div>
        <img class="type-icon" src="http://yanxuan.nosdn.127.net/hxm/yanxuan-wap/p/20161201/style/img/icon-normal/pickerArrow-a8b918f05f.png"/>
      </div>
    </div>
  </picker>
  <div class="fb-body">
