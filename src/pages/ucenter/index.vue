<template >
    <div class="container">
        ...
        <div class="profile-info clear">
            ...
            <div v-else
                 class="user_info clear">
                <div class="user_info_img NotLogged">
                    <img class="icon"
                         src="/static/images/ic_menu_me_pressed.png" />
                </div>
                <div class="user_info_txt">
                    <button v-if="canIUse"
                            open-type="getUserInfo"
                            @getuserinfo="goLogin"
                            class="goLoginBtn">点击，授权登录~</button>
                </div>
            </div>
        ...
        <navigator url="../../walletPages/wallet"
                   class="collection list clear"
                   v-if="!isYinXun">
        ...
        <navigator url="../../walletPages/activityWallet"
                   class="collection list clear"
                   v-if="!isYinXun">
            <div class="t">广告物料预存余额</div>
            <img class="i"
                 src="/static/images/address_right.png"
                 background-size="cover" />
        </navigator>

        <navigator url="../../addressPages/address"
                   class="address list clear">
        ...
        <!-- 印讯使用微信自带的客服 -->
        <button class="form_button service list clear"
                v-if="isYinXun"
                open-type="contact">
        ...
        <button v-if="userInfo.Id"
                open-type="getUserInfo"
                @getuserinfo="switchAccount "
                class="ShoppingCar list clear">
            <div class="t"
                 style="text-align:left;">切换账号</div>
            <img class="i"
                 src="/static/images/address_right.png"
                 background-size="cover" />
        </button>
...
export default {
    ...
    methods: {
        ...mapActions(["sassLogin"]),
        ...mapMutations(["setUserInfo", "setUserAddressList", "setWxUserInfo"]),
        // 根据用户OpenId获取是否有店铺信息
